          ...
          <div className="flex items-center justify-between">
            ...
            {creatingOnChain && (
              <div className="flex items-center space-x-2 text-purple-600">
                <Loader2 className="w-4 h-4 animate-spin" />
                <span className="text-sm font-medium">Minting reward coins...</span>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg p-6 border">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">{userProfile?.totalCoinsEarned || 0}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">Types Owned:</span>
                <span className="font-medium">{Object.keys(userProfile?.coinBalances || {}).length}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 border">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-purple-600">Zora + Uniswap</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="mt-3 p-3 bg-purple-50 rounded-lg border border-purple-200">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-purple-800">
                    Earn coins for every correct prediction: ACC, STR, ORC, RSK, and more!
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="p-6">
              {bets.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400 text-xs">Start swiping to make predictions and earn coins!</p>
                </div>
              ) : (
